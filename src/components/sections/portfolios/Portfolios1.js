					...
					<div className="col-12">
						<div className="sec-heading-wrap">
							<span className="sub-title wow fadeInUp" data-wow-delay=".3s">
								<i className="tji-box"></i>FEATURED PROJECTS
							</span>
							<div className="heading-wrap-content">
								<div className="sec-heading">
									<h2 className="sec-title title-anim">
										Proven Work, <span>Real Outcomes.</span>
									</h2>
								</div>
								<p className="desc wow fadeInUp" data-wow-delay=".5s">
									We turn complex requirements into clean, scalable solutions—delivered with clear scope, timelines, and measurable impact.
								</p>
